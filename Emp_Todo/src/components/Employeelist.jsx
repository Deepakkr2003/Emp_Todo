...
const EmployeeList = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r rounded-2xl from-red-200 via-violet-400 to-orange-400 p-8 flex justify-center items-center">
          ...
          <ul className="space-y-4">
            {employees.map((employee) => (
              <li
                ...
                className="p-4 bg-gradient-to-r from-amber-300 to-teal-400 rounded-md shadow-lg flex justify-between items-center hover:scale-105 transition-all duration-300"
              >
